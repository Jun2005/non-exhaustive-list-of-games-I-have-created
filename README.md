## Non-exhaustive list of games I have created
This is a collection of some of the games I have created independently on Unity.

## Kayak game

https://github.com/user-attachments/assets/1634c2b0-9b6f-4e23-bdf6-1d967aa9383c

An incomplete racing game involving kayaks that gain speed boosts as it soars through the sky. 
...
My first mobile game that involved a character that could slam the ground to create rocks. The rocks can be used as a barrier to keep enemies away, or they can be hit to damage enemies. The game used simple swipe controls.
